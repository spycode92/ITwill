...
//		arr[4] = 5;
		...
		// 별도로 정수형 리터럴 1, 2, 3, 4, 5 로 한꺼번에 초기화하는 경우
		int[] arr2;
//		arr2 = new int[5];
//		arr2 = {1, 2, 3, 4, 5}; // 오류 발생! 별도로 초기화 시 사용 불가능
		// => Array constants can only be used in initializers
		// => 해결방법 : new 키워드를 사용하는 방법과 결합하여 문법을 지정해야 함
		arr2 = new int[] {1, 2, 3, 4, 5};
		// 주의! 배열 크기는 지정하지 않도록 한다!
		
		System.out.println("-------------------------------------");
		
		// String 타입 문자열 데이터 3개("JAVA", "JSP", "SPRING") 를 저장하는
		// 배열 strArr를 생성하고 리터럴로 즉시 초기화까지 수행 후 출력
